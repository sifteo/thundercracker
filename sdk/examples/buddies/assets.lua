...
ShakeToShuffleOrange = image{"assets/ui_top_shakeshuffle_orange.png"}
ScoreTimeBlue = image{"assets/ui_top_time_blue.png"}
...
FontRed = image{"assets/font-8x16_red.png", height = 16}
