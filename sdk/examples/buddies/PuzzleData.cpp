...
void InitializePuzzles()
{
    ...
    sPuzzles[sNumPuzzles].AddCutsceneLineStart(CutsceneLine(CutsceneLine::VIEW_RIGHT, CutsceneLine::POSITION_LEFT, "Gimme a kiss!"));
    sPuzzles[sNumPuzzles].AddCutsceneLineStart(CutsceneLine(CutsceneLine::VIEW_LEFT, CutsceneLine::POSITION_RIGHT, "Can I use your\nmouth?"));
    sPuzzles[sNumPuzzles].AddCutsceneLineStart(CutsceneLine(CutsceneLine::VIEW_FRONT, CutsceneLine::POSITION_LEFT, "..."));
    sPuzzles[sNumPuzzles].AddCutsceneLineStart(CutsceneLine(CutsceneLine::VIEW_RIGHT, CutsceneLine::POSITION_LEFT, "OK!"));
    sPuzzles[sNumPuzzles].AddCutsceneLineEnd(CutsceneLine(CutsceneLine::VIEW_LEFT, CutsceneLine::POSITION_RIGHT, "Muuuahhh!"));
    sPuzzles[sNumPuzzles].AddCutsceneLineEnd(CutsceneLine(CutsceneLine::VIEW_RIGHT, CutsceneLine::POSITION_LEFT, "Hot n' heavy!"));
    ...
    sPuzzles[sNumPuzzles].AddCutsceneLineStart(CutsceneLine(CutsceneLine::VIEW_RIGHT, CutsceneLine::POSITION_LEFT, "Let's get\nCRAZY!"));
    sPuzzles[sNumPuzzles].AddCutsceneLineEnd(CutsceneLine(CutsceneLine::VIEW_LEFT, CutsceneLine::POSITION_RIGHT, "My head hurts."));
    ...
    sPuzzles[sNumPuzzles].AddCutsceneLineStart(CutsceneLine(CutsceneLine::VIEW_RIGHT, CutsceneLine::POSITION_LEFT, "How do I get\ncool hair\nlike you?"));
    sPuzzles[sNumPuzzles].AddCutsceneLineEnd(CutsceneLine(CutsceneLine::VIEW_RIGHT, CutsceneLine::POSITION_LEFT, "Now I look\nlike Kelly!"));
    ...
    sPuzzles[sNumPuzzles].AddCutsceneLineStart(CutsceneLine(CutsceneLine::VIEW_RIGHT, CutsceneLine::POSITION_LEFT, "See the world\nfrom my eyes!"));
    sPuzzles[sNumPuzzles].AddCutsceneLineEnd(CutsceneLine(CutsceneLine::VIEW_RIGHT, CutsceneLine::POSITION_LEFT, "That's much\nbetter."));
