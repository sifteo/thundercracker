...
enum GameState
{
    ...
    GAME_STATE_PUZZLE_CHAPTER_START,
    GAME_STATE_PUZZLE_CUTSCENE_START,
    GAME_STATE_PUZZLE_DISPLAY_START_STATE,
    GAME_STATE_PUZZLE_CLUE,
    GAME_STATE_PUZZLE_PLAY,
    GAME_STATE_PUZZLE_SOLVED,
    GAME_STATE_PUZZLE_CUTSCENE_END,
    GAME_STATE_PUZZLE_CHAPTER_END,
