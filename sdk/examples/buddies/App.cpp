...
// TODO: Go back to 64 char strings and full versions once LOG bug is fixed.
// TODO: Get this wrapped only in a DEBUG build
const char kGameStateNames[NUM_GAME_STATES][28] =
{
    "GAME_STATE_NONE",
    ...
    "GAME_STATE_SHUFFLE_MEMORIZE", // "GAME_STATE_SHUFFLE_MEMORIZE_",
    "GAME_STATE_SHUFFLE_SPLASH", //"GAME_STATE_SHUFFLE_CHARACTER_SPLASH",
    "GAME_STATE_SHUFFLE_SHAKE", //"GAME_STATE_SHUFFLE_SHAKE_TO_SHUFFLE",
    "GAME_STATE_SHUFFLE_SHUFFLIN",
    "GAME_STATE_SHUFFLE_UNSHUFF", //"GAME_STATE_SHUFFLE_UNSHUFFLE_THE_FACES",
    "GAME_STATE_SHUFFLE_PLAY",
    "GAME_STATE_SHUFFLE_OPTIONS",
    "GAME_STATE_SHUFFLE_SOLVED",
    "GAME_STATE_SHUFFLE_CONGRATS", //"GAME_STATE_SHUFFLE_CONGRATULATIONS",
    "GAME_STATE_SHUFFLE_ENDNAV", //"GAME_STATE_SHUFFLE_END_GAME_NAV",
    "GAME_STATE_STORY_START",
    "GAME_STATE_STORY_CHAP_START", //"GAME_STATE_STORY_CHAPTER_START",
    "GAME_STATE_STORY_CUT_START", //"GAME_STATE_STORY_CUTSCENE_START",
    "GAME_STATE_STORY_DISPSTART", //"GAME_STATE_STORY_DISPLAY_START_STATE",
    "GAME_STATE_STORY_SCRAMBLING",
    "GAME_STATE_STORY_CLUE",
    "GAME_STATE_STORY_PLAY",
    "GAME_STATE_STORY_OPTIONS",
    "GAME_STATE_STORY_SOLVED",
    "GAME_STATE_STORY_CUT_END_1", //"GAME_STATE_STORY_CUTSCENE_END_1",
    "GAME_STATE_STORY_CUT_END_2", //"GAME_STATE_STORY_CUTSCENE_END_2",
