...
void TimeKeeper::DrawMeter( float amount, BG1Helper &bg1helper, VidMode_BG0_SPR_BG1 &vid )
{
    ...
    if( numStems <= 2 )
    {
        float spritePerc = 1.0f - fmodf( m_fTimer, TIMER_LOW_SPRITE_PERIOD ) / TIMER_LOW_SPRITE_PERIOD;
    ...
    else
    {
        ...
        float spritePerc = 1.0f - fmodf( m_fTimer, TIMER_SPRITE_PERIOD ) / TIMER_SPRITE_PERIOD;
