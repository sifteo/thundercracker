...
namespace TotalsGame {
    ...
    namespace TutorialController 
    {
        ...
        extern float remembered_t;
        extern Puzzle *puzzle;
        extern TokenView *firstToken, *secondToken;
        extern float rememberedTimeout;
        extern int rememberedCubeId;
        extern int rememberedFinishCountdown ;
