...
sfx_PeanosVaultCrimeWave = sound { "PeanosVaultCrimeWave.raw" }
sfx_PeanosVaultInsideJob = sound { "PeanosVaultInsideJob.raw" }
sfx_PeanosVaultSneakers = sound { "PeanosVaultSneakers.raw" }
sfx_Hide_Overlay = sound { "PV_hide_overlay.raw" }
sfx_Hint_Deny_01 = sound { "PV_hint_deny_01.raw" }
