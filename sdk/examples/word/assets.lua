...
BorderLeftNoNeighbor = image{"border_left_noneighbor.png", quality=8}
BorderSlotBlank = image{"border_available.png", quality=8}
BorderSlotNormal = image{"border_created_basic.png", quality=8, width=16}
BorderSlotBonus = image{"border_created_bonus.png", quality=8, width=16}
...
Title = image{"wp2_gameselect.png", quality=8}
HighScores = image{"score_highscores.png", quality=8}
