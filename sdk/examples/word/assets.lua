...
EyeLeft = image{"teeth_numbers.png", width=16, height=16, quality=10, pinned=true}
EyeRight = image{"teeth_numbers.png", width=16, height=16, quality=10, pinned=true}
EyeLeftBlink = image{"teeth_numbers.png", width=16, height=16, quality=10, pinned=true}
EyeRightBlink = image{"teeth_numbers.png", width=16, height=16, quality=10, pinned=true}
