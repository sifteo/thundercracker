...
#define PIPE_SIFTEO_BASE_FIRMWARE_REVISION_STRING_SET 3
...
/** @brief do a set_local_data for PIPE_SIFTEO_BASE_FIRMWARE_REVISION_STRING_SET
 *  @param src source buffer to send data from.
 *             Presentation format: UTF-8 string
 *  @param size the number of bytes to send. Maximum size is 8
 *  @details use this function to do a set_local_data for PIPE_SIFTEO_BASE_FIRMWARE_REVISION_STRING_SET. If no transaction are currently
 ...
 */
void services_set_sifteo_base_firmware_revision_string(void *src, int size);
...
#define SETUP_MESSAGES_CONTENT {\
    ...
    {0x00,\
        {\
            0x1f,0x06,0x10,0x38,0xff,0xff,0x02,0x58,0x00,0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x40,0x00,0x00,\
    ...
    {0x00,\
        {\
            0x1f,0x06,0x21,0x18,0x02,0x10,0x00,0x26,0x2a,0x06,0x04,0x09,0x08,0x00,0x10,0x2a,0x26,0x01,0x00,0x00,\
            0x00,0x00,0x00,0x00,0x00,0x00,0x06,0x04,0x08,0x07,0x00,0x11,\
        },\
    },\
    {0x00,\
        {\
            0x0e,0x06,0x21,0x34,0x29,0x04,0x01,0x19,0x00,0x00,0x00,0x01,0x00,0x00,0x00,\
        },\
    },\
    {0x00,\
        {\
            0x1f,0x06,0x40,0x00,0x00,0x02,0x02,0x00,0x02,0x04,0x00,0x0b,0x00,0x0c,0x00,0x03,0x02,0x00,0x08,0x04,\
            0x00,0x0e,0x00,0x00,0x2a,0x26,0x01,0x00,0x80,0x04,0x00,0x10,\
        },\
    },\
    {0x00,\
        {\
    ...
    {0x00,\
        {\
            0x06,0x06,0xf0,0x00,0x03,0xec,0x2e,\
        },\
    },\
}
